...
namespace TurnUpPortalJune2025.Pages
{
    public class TimeAndMaterialsPage : BasePage
    {
        ...
        public void CreateNewRecord()
        {
            ...
            enterCodeBox.SendKeys("TestRush");
            ...
            Thread.Sleep(3000);
            Assert.That(lastRowRecord.Text == "TestRush", "Record not found");
        ...
        public void DeleteLastRowRecord()
        {
            ...
            Thread.Sleep(2000);
            Assert.That(newLastRowRecord2.Text != "NewTestRush", "Record not deleted");
